return function(Iris, widgets)
	...
	local function UpdateChildContainerTransform(thisWidget)
		...
		local ChildContainerHeight = thisWidget.LabelHeight * math.min(thisWidget.NumChildrenForSize, 8)
			- 2 * ChildContainerBorderSize
	...
	widgets.PluginUserInput.InputBegan:Connect(function(inputObject)
		if
